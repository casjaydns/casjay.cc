...
$config['db_database'] = '/var/lib/httpd/stikked'; // you need to create a directory "db" and give the webserver write access. sqlite needs a writable folder to work properly!
 ...
 * Currently: default, bootstrap, darkly, gabdark, gabdark3, geocities, snowkat, stikkedizr, cleanwhite, i386
 *
 */
$config['theme'] = 'gabdark';
...
//
//
$config['cron_key'] = 'K8VToTr7BqOF3gtY2VPpUSEWBwEf9bBGcUk29H3JrLHDz9EOzw1ADaHPmo7kFxxf';
...
$config['backup_pass'] = 'Niqkuq98aIFffWREo3w8e5JX6wfDTRejWSWHSAgfj57xgIFXXhHlajaRsqaT492F';
...
$config['spamadmin_pass'] = 'Niqkuq98aIFffWREo3w8e5JX6wfDTRejWSWHSAgfj57xgIFXXhHlajaRsqaT492F';
